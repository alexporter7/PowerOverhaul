...
public class EngineBlock6Model extends PowerOverhaulModelBase {
    ...
    public EngineBlock6Model() {
        ...
        top.cubeList.add(new ModelBox(top, 0, 54, -6.0F, -12.0F, -8.0F, 2, 6, 16, 0.0F));
        top.cubeList.add(new ModelBox(top, 36, 54, 4.0F, -12.0F, -8.0F, 2, 6, 16, 0.0F));
        ...
        leftBank.setRotationPoint(1.0F, 0.0F, 0.0F);
        ...
        cylinderB.cubeList.add(new ModelBox(cylinderB, 60, 0, -2.0F, -12.0F, -9.0F, 4, 6, 4, 0.0F));
        ...
        cylinderD.cubeList.add(new ModelBox(cylinderD, 60, 10, -2.0F, -12.0F, -3.0F, 4, 6, 2, 0.0F));
        cylinderD.cubeList.add(new ModelBox(cylinderD, 76, 0, -2.0F, -12.0F, -6.0F, 4, 6, 1, 0.0F));

        rightBank = new ModelRenderer(this);
        rightBank.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        cylinderB2.cubeList.add(new ModelBox(cylinderB2, 72, 10, -2.0F, -12.0F, -7.0F, 4, 6, 2, 0.0F));
        ...
        cylinderD2.cubeList.add(new ModelBox(cylinderD2, 72, 54, -2.0F, -12.0F, -3.0F, 4, 6, 4, 0.0F));
