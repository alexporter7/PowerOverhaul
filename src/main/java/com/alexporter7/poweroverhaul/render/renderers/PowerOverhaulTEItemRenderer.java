...
public class PowerOverhaulTEItemRenderer implements IItemRenderer {

    private final TileEntitySpecialRenderer renderer;
    private final TileEntity tileEntity;

    public PowerOverhaulTEItemRenderer(TileEntitySpecialRenderer render, TileEntity tileEntity) {
